...
#define LG_HOST_REGISTRY(X) \
    ...
    X(ContextMenu,    "dylv.liquidglass.contextmenu",  "ContextMenu",   28.0f / 220.0f, (28.0f / 220.0f) * 1.8f,       20.0f, 1.5f, 1.50f, 0.0f, 1.0f,  0.0f, "#FFFFFFCC", "#00000040") \
    ...
    X(DynamicIsland,  "dylv.liquidglass.dynamicisland","DynamicIsland",   0.50f,          0.35f,                         40.0f, 3.5f, 1.80f, 1.5f, 1.0f,  0.8f, "#FFFFFF20", "#00000030")
